...
/**
 * Created by AlexSkorikov on 27.05.18.
 */
public class Connect implements Connection {
     ...
     * New connection.
     *
     * @param connection        VanilConnection.
     * @param connectionPool connectionPool.
     */
    Connect(Connection connection, ConnectionPool connectionPool) {
    ...
    @Override
    public void close() {
        if (!connectionPool.getConnectionsPool().offer(connection)) {
